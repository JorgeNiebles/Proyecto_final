...
app.get('/contactanos', (req, res) => {
    ...
    res.render('contactanos', { message: null });
});
...
app.post('/submitContactanos', (req, res) => {
    const { nombre, email, telefono, mensaje } = req.body;

    db.query('INSERT INTO contactanos (nombre, email, telefono, mensaje) VALUES (?, ?, ?, ?)', [nombre, email, telefono, mensaje], (err, result) => {
        if(err) {
            console.log(err);
            res.send('Error al insertar usuario');
        }else {
            console.log(result);
            res.render('contactanos', {message: 'Nos pondremos en contacto contigo en la brevedad.'});
